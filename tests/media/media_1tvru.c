...
static const gchar *URLs[] =
{
  ...
  "http://www.1tv.ru/sprojects_utro_video/si33/p68199",
  NULL
};

static const gchar *TITLEs[] =
{
  "Познер. Гость в студии - Леонид Рошаль",
  "Вся правда о \"коробочниках\"",
  NULL
};
...
gint main(gint argc, gchar **argv)
{
  ...
  g_test_add_func("/media/1tvru", test_media_1tvru);
  return (g_test_run());
}
